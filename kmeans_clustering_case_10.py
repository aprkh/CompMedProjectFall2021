...
df_num = df.loc[:, (df.columns != 'Participant_ID') & (df.columns != 'CtrlVsCase_Classifier')]
...
for index, row in df.iterrows():
    if row['CtrlVsCase_Classifier'] == 0: #bulbar
        onset_colors[index] = 'green'
    elif row['CtrlVsCase_Classifier'] == 1: #limb
...
# compare MDS clustering with actual case vs. control
...
axs[1].set_title("Case vs. Control")

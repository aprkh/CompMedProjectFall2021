##---------------------------------------------------------
## Uses same workflow as in bulbar vs limb analysis
## code adapted from 
...
load("ctrl_vs_case/ctrl_data_preprocessed")
...
df_bulbar_no_ID[,target_var] <- as.factor(df_bulbar_no_ID[,target_var])
df_upsample <- smote(CtrlVsCase_Classifier~., df_bulbar_no_ID, 
